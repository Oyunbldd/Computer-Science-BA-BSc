...
//If you using recursion function declare always stopping condition
...
droptake2 :: [Int] -> [Int]
droptake2 [] = []
droptake2 x = drop 2 takenX

where takenX = take (length x - 2) x

// Start = droptake2 [1, 2, 3, 4, 5, 6, 7, 8, 9] // [3,4,5,6,7]
//Start = droptake2 [1, 2]
...
del_firstlast [] = []
del_firstlast x = drop 1 deletedLastElement
where deletedLastElement = take (length x - 1) x

// Start = del_firstlast [1..10]

//tl -> tail [1,2,3,4] => [2,3,4]
//init -> removing last element in list 
// init [1,2,3,5] => [1,2,3]
