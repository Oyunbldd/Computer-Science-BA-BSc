...
tilt :: Int  -> Int 
tilt x = (x rem 10 ) * (10 ^ countDigit x) + (x/10)
...
manyTimes :: [Int] -> Int 
manyTimes lst = length [1 \\ x <- lst | x == 1]

doubleOne :: [Int] -> [Int]
doubleOne lst = [x \\ x <- lst | manyTimes (intToList x) >= 2]
...
qwe :: Int [Int] -> Bool
qwe x lst
| length[1 \\ i<-lst | i == x] == 0 = True
= False


fourHelper :: [Int] [Int] -> [Int]
fourHelper lst1 lst2 = [x \\ x <-lst1  | qwe x lst2 ]


difference :: [[Int]] [[Int]] -> [[Int]] 
difference lst1 lst2 = [ fourHelper i j \\ i<-lst1 & j<-lst2]
...
fiveHelper :: [Int] Int -> [Int]
fiveHelper [] x = [x]
fiveHelper lst x = updateAt ((length lst) / 2) x lst


repMid :: [[Int]] Int -> [[Int]]
repMid lst x = [fiveHelper i x\\ i <-lst]
...
| x == 2 = True
| x == 3 = True
= length [1 \\ i <- [2..(x-1)] | x rem i == 0 ] == 0 


primes7 :: [Int] -> [Int]
primes7 lst = [x \\ x <-lst | x rem 10 == 7 && isPrime x ]
...
holdsTrue [] = False
holdsTrue lst 
| length [True \\ x <- lst | ((fst x) rem 2 <> 0) && ((snd x) rem 2 == 0) ] == 0 = True
= False
...
eightHelper lst 
| (length lst) == 1 = lst !! 0
=  eightHelper (intToList(sum lst))



super_digit :: [Int] -> [Int]
super_digit lst = [eightHelper (intToList x) \\ x <- lst]
...
| x == 1 = True
| x rem n <> 0 = False
| gg x == 1 && x rem n == 0 && x < n = True
= check (x/n) n


powersList :: [Int] Int -> [Int]
powersList lst n = [x \\ x <- lst | check x n]
...
twinPrimes x y = length [(i,i+2) \\ i<-[x..y] | isPrime i && isPrime (i+2) ]
